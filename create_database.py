...
try:
    ...
    restaurants_data = [
        ...
        {"name": "Тайська кухня", "description": "Пікантні тайські страви", "image_url": "https://images.unsplash.com/photo-1559314809-0c8cc0b8b0b8?w=800&q=80", 
         "rating": 3.8, "delivery_time": 35, "delivery_fee": 45.0, "min_order": 180.0, "category": "Азіатська кухня", "text_filters": ["Найпопулярніше", "Акції"]},
        {"name": "В'єтнамська кухня", "description": "Свіжі в'єтнамські страви", "image_url": "https://images.unsplash.com/photo-1546069901-ec6473dfe7b1?w=800&q=80", 
         "rating": 4.1, "delivery_time": 30, "delivery_fee": 40.0, "min_order": 160.0, "category": "Азіатська кухня", "text_filters": ["На виніс"]},
        ...
        {"name": "Brunch Cafe", "description": "Розкішні бранчі та сніданки", "image_url": "https://images.unsplash.com/photo-1506084868230-bb9d95c24759?w=800&q=80", 
         "rating": 4.7, "delivery_time": 30, "delivery_fee": 40.0, "min_order": 150.0, "category": "Сніданки", "text_filters": ["Найпопулярніше"]},
        ...
        {"name": "Круасани & Кава", "description": "Свіжі круасани та ароматна кава", "image_url": "https://images.unsplash.com/photo-1519869325934-281144150011?w=800&q=80", 
         "rating": 4.6, "delivery_time": 22, "delivery_fee": 28.0, "min_order": 85.0, "category": "Круасани", "text_filters": ["Найпопулярніше"]},
        ...
        {"name": "Цукерня", "description": "Традиційні солодощі та цукерки", "image_url": "https://images.unsplash.com/photo-1586985289688-ca3cf47d3e6d?w=800&q=80", 
         "rating": 4.5, "delivery_time": 30, "delivery_fee": 40.0, "min_order": 150.0, "category": "Кондитерські", "text_filters": ["На виніс"]},
        {"name": "Шоколадна фабрика", "description": "Шоколадні десерти та цукерки", "image_url": "https://images.unsplash.com/photo-1606312619070-d48b4e6b3c5e?w=800&q=80", 
         "rating": 4.2, "delivery_time": 35, "delivery_fee": 45.0, "min_order": 170.0, "category": "Кондитерські", "text_filters": ["Промокоди", "Найпопулярніше"]},
        {"name": "Тортова майстерня", "description": "Святкові торти на замовлення", "image_url": "https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=800&q=80", 
         "rating": 3.9, "delivery_time": 45, "delivery_fee": 55.0, "min_order": 250.0, "category": "Кондитерські", "text_filters": ["Акції", "На виніс"]},
    ]
    ...
    for rest_data in restaurants_data:
        ...
        db.add(restaurant)
        print(f"Додано ресторан: {rest_data['name']} (відстань: {distance} км, категорія: {category_name}, фільтри: {', '.join(text_filter_names)})")
